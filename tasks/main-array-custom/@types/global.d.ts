declare global {
  interface Array<T> {
     ...
     */
    associateBy<U>(keySelector: (key: T) => U): Map<U, T>;
    /**
     ...
     */
    distinctBy<U>(selector: (key: T) => U): T[];
    /**
     ...
     */
    fold<U extends T>(initial: U, operation: (acc: U, value: T) => U): U;
    /**
     ...
     */
    groupBy<K, U>(keySelector: (key: T) => K, valueTransform?: (value: T) => U): Map<U, T[]>;
  }
}
export {};
